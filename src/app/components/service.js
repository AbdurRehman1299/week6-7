  ...
  return (
    <div>
        ...
        <div className='grid grid-cols-2 gap-3 mx-20 mt-2'>
          <img src='image1.jpg' className='h-[400px] w-full'/>
          <img src='image2.jpg' className='h-[400px] w-full'/>
          <img src='image3.jpg' className='h-[400px] w-full'/>
          <img src='image4.jpg' className='h-[400px] w-full'/>
          <img src='image5.jpg' className='h-[400px] w-full'/>
          <img src='image6.jpg' className='h-[400px] w-full'/>
        </div>
    </div>
  )
}
